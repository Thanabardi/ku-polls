...
def create_question(question_text, pub_days, end_days):
    """
    Create a question with the given `question_text` published and end in the
...
class QuestionTests(TestCase):
    ...
    def test_can_vote(self):
        ...
        question = Question(question_text="the day between pub date and end date.", pub_date=pub_time, end_date=end_time)
